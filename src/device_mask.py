...
def compute_device_regions(parameters,key_file):
    ...
    for index, row in key_file.iterrows():
        ...
        monolayer_end_um = int(monolayer_end/parameters["pixel_to_micron_ratio"])
        open_space_start_um = int((open_space_start - monolayer_end)/parameters["pixel_to_micron_ratio"])
        open_space_end_um = int((open_space_end - monolayer_end)/parameters["pixel_to_micron_ratio"])    
